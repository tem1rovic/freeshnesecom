...
const SearchField: FC = () => {
    ...
    return (
        <div className={cl.Root}>
            <Dropdown type='large'><h1>All categories</h1></Dropdown>
            <input { ...input } type="text" placeholder='Search Products, categories ...'/>
            <span>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M5.81319 10.24L2.68652 13.3667" stroke="#151515" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="bevel"/>
                </svg>
            </span>
        </div>
    );
